...
S4: Alembic-Head = f3b8c2d1a6e4, schema_meta konsistent.
...
assert head == "d8e4c2b1a6f7", f"S4 Head falsch: {head}"
# S4: Alembic-Head = d8e4c2b1a6f7 (JFW-5 batches/batch_items/batch_attempts)
